      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center space-x-8 bg-[#F0EFEF] border border-gray-300 rounded-md px-6 py-3 shadow-sm">
          <NavLink to="/home" className="flex items-center space-x-2">
            ...
            <span className="text-xl font-semibold text-gray-900">ByteBlog</span>
          </NavLink>

          <ul className="hidden md:flex space-x-6 text-gray-600 font-medium">
            <li><NavLink to="/pricing" className="hover:text-black transition">Pricing</NavLink></li>
            <li><NavLink to="/post" className="hover:text-black transition">Post +</NavLink></li>
            <li><NavLink to="/cases" className="hover:text-black transition">Cases</NavLink></li>
            <li><NavLink to="/code" className="hover:text-black transition">Code</NavLink></li>
          </ul>
        </div>
        ...
        <div className="flex items-center space-x-4 bg-[#F0EFEF] border border-gray-300 rounded-md px-6 py-3 shadow-sm">
          ...
          <button className="hidden md:block p-2 cursor-pointer rounded-full border border-gray-300 hover:bg-gray-100 transition">
          ...
          {!username ? (
            currentPath === "/login" ? (
              <NavLink to="/register" className="relative group cursor-pointer overflow-hidden px-6 py-2 font-semibold text-white bg-black rounded-md transition-all duration-300 hover:scale-95">
                <span className="relative z-10 group-hover:text-black transition-colors duration-300">Register</span>
              ...
              <NavLink to="/login" className="relative group cursor-pointer overflow-hidden px-6 py-2 font-semibold text-white bg-black rounded-md transition-all duration-300 hover:scale-95">
            ...
            <div
              className={`relative group inline-block ${isMobile ? "" : "cursor-pointer"}`}
              onClick={toggleDropdown} // only works on mobile
            >
              <span
              ...
              >
                <span
                  className="relative z-10 group-hover:text-black transition-colors duration-300 truncate min-w-[87px] max-w-[100px] block"
                >
                  Hi, {username}
                </span>
              ...
              >
                <NavLink
                  to="/profile"
                  className="w-min text-left px-11 py-2 bg-black text-white rounded-md
